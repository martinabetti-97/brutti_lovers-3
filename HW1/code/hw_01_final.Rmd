...
We plot some of the elements of $\mathcal{G}_{d,q}$ with $q\in\{1,3,5\}$ and $d\in\{3,5,10\}$ equispaced knots in the interval $[0,1]$. The visualized elements are chosen randomly.
...
fhat_plot <- function(q, train) {
  ...
  plot( y ~ x , train, lwd = 2, col = rgb(.1, .1, .1, .6), main = paste("Degree-3 spline with q=", q, sep=""))
