...
The design matrix $X$ contains the TF-IDF scores for each word (feature) in each review. Specifically, it has a (`r dim(X_tr)`) size.
...
result <- gradient_descent(X_tr, y_tr_encoded, gradient_linear, alpha=0.001, max_iter=100, plot=T, verbose = 10)
